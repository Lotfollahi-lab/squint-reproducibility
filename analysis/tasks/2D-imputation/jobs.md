...
- `./scripts/wrapper_sweep_train_model.sh mmb0-4b_1p 3-test-patch-split vqniche_graphsage seed 6 gpu-lotfollahi-train`
- `./scripts/wrapper_sweep_train_model.sh xhs1000-39b_1p-oriented-3 3-test-patch-split vqniche_graphsage seed 6 gpu-lotfollahi-train`
- `./scripts/wrapper_sweep_train_model.sh xhk1020-CV1-CV2-5b_1p 3-test-patch-split vqniche_graphsage seed 6 gpu-lotfollahi-train`


## Skin (Human) (3 Test Regions) -- Increasing Training Sections

- `./scripts/wrapper_sweep_train_model.sh xhs1000-39b_1p-oriented-3 3-test-patch-split vqniche_graphsage seed 6 gpu-lotfollahi-train`
- `./scripts/wrapper_sweep_train_model.sh xhs1000-39b_1p-oriented-4 3-test-patch-split vqniche_graphsage seed 6 gpu-lotfollahi-train`
