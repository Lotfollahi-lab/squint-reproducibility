...
attr_impute_metrics = ['codebook_utilization', 'pearson_cell_wise', 'pearson_1hop_nbr', 'mmd_1hop_nbr', 'mmd_pca_1hop_nbr', 'pearson_gene_wise', 'pearson_gene_wise_1hop_nbr', 'energy_1hop_nbr', 'energy_pca_1hop_nbr']
# attr_impute_metrics = []
...
def test(config: Dict):
    ...
    model.test_metrics_list = METRICS_LIST
